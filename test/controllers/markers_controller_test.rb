...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { desc: @marker.desc, img: @marker.img, tit: @marker.tit } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { desc: @marker.desc, img: @marker.img, tit: @marker.tit } }
