...
class PostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poster" do
    assert_difference('Poster.count') do
      post posters_url, params: { poster: { cost: @poster.cost, descr: @poster.descr, fech: @poster.fech, fot: @poster.fot, name: @poster.name } }
    end
  ...
  test "should update poster" do
    patch poster_url(@poster), params: { poster: { cost: @poster.cost, descr: @poster.descr, fech: @poster.fech, fot: @poster.fot, name: @poster.name } }
