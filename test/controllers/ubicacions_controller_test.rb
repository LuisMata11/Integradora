...
class UbicacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ubicacion" do
    assert_difference('Ubicacion.count') do
      post ubicacions_url, params: { ubicacion: { descripcion: @ubicacion.descripcion, direccion: @ubicacion.direccion, latitud: @ubicacion.latitud, longitud: @ubicacion.longitud, titulo: @ubicacion.titulo } }
    end
  ...
  test "should update ubicacion" do
    patch ubicacion_url(@ubicacion), params: { ubicacion: { descripcion: @ubicacion.descripcion, direccion: @ubicacion.direccion, latitud: @ubicacion.latitud, longitud: @ubicacion.longitud, titulo: @ubicacion.titulo } }
